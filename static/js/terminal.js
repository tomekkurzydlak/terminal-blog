...
if (cmd === "run dino") {
    ...
    const fakeFiles = {
        ...
        ".credits.txt": `Behind the scenes, someone built the frame.
Threads of data spun into patterns.
Machines that speak. Pipelines that think.
Tools shaped to fit the problem — never the other way around.
Not for fame. Not for titles.
Just the joy of systems that click into place.
https://www.linkedin.com/in/tomasz-kurzydlak/
`,
